  ...
  return (
    <div className='blog-page'>
      <div className="container">
        ...
        <OneBlog classn="blog-1" name="Digital Marketing News" settings={settings}  blogs={blogs} />
        <OneBlog classn="blog-2" name="Latest Updates & Insights" settings={settings}  blogs={blogs} />
        <OneBlog classn="blog-3" name="Tips & Strategies" settings={settings}  blogs={blogs} />
